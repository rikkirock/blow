    ...
    <section class="pt-120 pb-120">
        <div class="container">
            <div class="row" id="game-start-area">
                <div class="col-md-6">
                    <img class="h-100" src="{{ asset(activeTemplate(true) . 'images/blackjack-preview.png') }}"
                        alt="@lang('image')">
                </div>
                <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">
                                    ...
                                    <span class="text--warning">
                                        @lang('Win Amount') {{ getAmount($game->win + 100) }}%
                                    </span>
                                </small>
                            </div>
                            <div class="mt-5">
                                <button class="cmn-btn w-100 game play-btn" id="flip" type="submit">
                                    @lang('Play Now')
                                </button>
