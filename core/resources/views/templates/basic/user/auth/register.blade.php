...
@section('app')
    ...
    <section class="registration-section bg_img"
        style="background-image: url( {{ getImage('assets/images/frontend/register/' . @$register->data_values->image, '1920x960') }} );">
        <div class="registration-area  @if (!gs('registration')) form-disabled @endif">
            @if (!gs('registration'))
                <span class="lock-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink"
                        width="120" height="120" x="0" y="0" viewBox="0 0 512 512"
                        ...
                        <g>
                            <path
                                ...
                                fill="var(--bs-warning)" opacity="1" data-original="#000000"></path>
                            <path
                    ...
                    <div class="row">
                        ...
                        @if (gs('agree'))
                            ...
                            <div class="form-group d-flex align-items-start">
                                <input class="custom_checkbox" id="agree" name="agree" type="checkbox"
