                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <div class="input-group">
                            <input class="form-control form-control-lg referralURL" type="text"
                                value="{{ route('home') }}?reference={{ auth()->user()->username }}" readonly>
                            <button class="input-group-text bg--base -bottom-left-copytext" id="copyBoard" type="button"><i
                                ...
                                <div class="treeview-container">
                                    <ul class="treeview">
                                        <li class="items-expanded"> {{ $user->fullname }} ( {{ $user->username }} )
                                            @include('Template::partials.under_tree', [
                                                'user' => $user,
                                                'layer' => 0,
                                                'isFirst' => true,
                                            ])
