        ...
        <div class="col-md-8">
            <div class="card custom--card">
                ...
                <div class="card-body">
                    ...
                    <form id="payment-form" class="disableSubmission appPayment" role="form" method="{{ $data->method }}"
                        action="{{ $data->url }}">
                        @csrf
                        ...
                        <div class="row gy-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form--control" name="cardExpiry" type="tel"
                                    value="{{ old('cardExpiry') }}" autocomplete="off" required />
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">@lang('CVC Code')</label>
                                <input class="form--control" name="cardCVC" type="tel" value="{{ old('cardCVC') }}"
