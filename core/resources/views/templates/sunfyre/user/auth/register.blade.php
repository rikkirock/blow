                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink"
                            ...
                            <g>
                                <path
                                    ...
                                    fill="hsl(var(--warning) / .6)" opacity="1" data-original="#000000"></path>
                                <path
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-inner">
                                    ...
                                    <input class="form--control checkUser" type="email" name="email"
                                ...
                                <div class="col-12">
                                    <div class="form-group pt-3 col-12">
                                        <div class="form--check">
                                            <input class="form-check-input" name="agree" type="checkbox" id="remember"
                                                @checked(old('agree'))>
