                ...
                <div class="card-body">
                    <form method="POST">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" name="demo_balance" type="number"
                                            value="{{ getAmount(gs('demo_balance')) }}" step="any" required>
                                        <span class="input-group-text">{{ gs('cur_text') }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-sm-6">
                                <div class="form-group">
                                    <label>@lang('User Minimum Balance For Withdrawal')</label>
                                    <div class="input-group">
                                        <input class="form-control" name="min_balance" type="number"
                                            value="{{ getAmount(gs('min_balance')) }}" step="any" required>
                                        <span class="input-group-text">{{ gs('cur_text') }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="form-group">
                                    <label>@lang('Balance Transfer Percentage Charge')</label>
                                    <div class="input-group">
                                        <input class="form-control" name="balance_transfer_percent_charge" type="number"
                                            value="{{ getAmount(gs('balance_transfer_percent_charge')) }}" step="any"
                                            required>
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="form-group">
                                    <label>@lang('Gameplay Number For Bonus')</label>
                                    <input class="form-control" name="gameplay_number_for_bonus" type="number"
                                        value="{{ getAmount(gs('gameplay_number_for_bonus')) }}" step="any"
                                        required>
                                </div>
                            </div>
                            <div class="col-xl-4 col-sm-6">
                                <div class="form-group">
                                    <label>@lang('Gameplay Bonus')</label>
                                    <div class="input-group">
                                        <input class="form-control" name="gameplay_bonus" type="number"
                                            value="{{ getAmount(gs('gameplay_bonus')) }}" step="any"
                                            required>
                                        <span class="input-group-text">{{ gs('cur_text') }}</span>
                                    </div>
                                </div>
