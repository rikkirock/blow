                ...
                <form method="post">
                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Gameplay Bonus')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you enable this module, that means users will get a gameplay bonus that you\'ve set up from the') <a href="{{ route('admin.setting.general') }}">@lang('General Setting')</a> @lang('when he/she complete the specific gameplay number.')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="game_play" @if (gs('game_play')) checked @endif>
                                </div>
                            </li>
                            ...
                            <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    ...
                                    <p class="mb-0">
                                        <small>@lang('If you enable this module, that means users will be able to transfer their balance to another user.')</small>
                                    </p>
                                </div>
                                <div class="form-group">
